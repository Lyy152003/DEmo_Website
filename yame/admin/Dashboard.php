...
// Truy vấn số lượng yêu cầu dịch vụ
$sql_requests = "SELECT COUNT(*) AS totalRequests FROM orders";  // Bảng 'orders' chứa yêu cầu dịch vụ
            ...
            <div class="admin-dashboard">
                <h3>Hi, Welcome to Admin Dashboard 👋</h3>
                    <div class="stats">
						...
						<!-- Stat Item 5: Số lượng dịch vụ -->
						<div class="stat-item">
							<div class="stat-content">
								<h2>Số lượng dịch vụ</h2>
								<p><?php echo $totalServices; ?></p>
							</div>
							<i class="fas fa-concierge-bell icon"></i> <!-- Icon cho dịch vụ -->
						</div>

						<!-- Stat Item 6: Số lượng yêu cầu dịch vụ -->
						<div class="stat-item">
							<div class="stat-content">
								<h2>Yêu cầu dịch vụ</h2>
								<p><?php echo $totalRequests; ?></p>
							</div>
							<i class="fas fa-tools icon"></i> <!-- Icon cho yêu cầu sửa chữa -->
						</div>

                    </div>
					
					<h3 class="text-center">Thống Kê Doanh Thu Sản Phẩm Bán Ra 2025</h3>
